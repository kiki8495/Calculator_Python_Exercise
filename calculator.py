...
boton_3 = Button(ventana, text="3", width= 5, height=2, command=agregar_tres)
boton_4 = Button(ventana, text="4", width= 5, height=2, command=agregar_cuatro)
boton_5 = Button(ventana, text="5", width= 5, height=2, command=agregar_cinco)
boton_6 = Button(ventana, text="6", width= 5, height=2, command=agregar_seis)
boton_7 = Button(ventana, text="7", width= 5, height=2, command=agregar_siete)
boton_8 = Button(ventana, text="8", width= 5, height=2, command=agregar_ocho)
boton_9 = Button(ventana, text="9", width= 5, height=2, command=agregar_nueve)
boton_0 = Button(ventana, text="0", width=18, height=2, command=agregar_cero)
